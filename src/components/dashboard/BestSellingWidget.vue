...
const submitBid = async () => {
    ...
    try {
        ...
        await investmentService.invest({
            auction_id: selectedAuction.value.subasta_id,
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-0">
                ...
                <div class="p-6">
                    ...
                    <Carousel :value="getAuctionImages(auction)" :numVisible="1" :numScroll="1" :showIndicators="true"
                        :showNavigators="true" class="auction-carousel mb-4">
                        <template #item="carouselSlot">
                            <div class="relative h-48">
                                <img :src="carouselSlot.data" :alt="auction.nombre" class="w-full h-full object-cover rounded-lg" />
                            </div>
                        </template>
                    </Carousel>
                        ...
                        <div class="bg-gray-50 p-3 rounded-lg">
                            <div class="space-y-1 text-sm">
                                <div class="flex justify-between">
                                    <span class="text-gray-600">Meses:</span>
                ...
                <div class="bg-gray-50 p-6 flex flex-col">
                    ...
                    <div class="mb-4 text-center">
                        ...
                        <p class="text-xs text-gray-600">Finaliza: {{ formatDate(auction.finalizacion) }}</p>
                    </div>
                    ...
                    <div class="bg-green-50 p-4 rounded-lg border border-green-200 mb-4">
                        ...
                        <p class="text-sm text-green-600 text-center">{{ auction.Moneda }}</p>
                    </div>
                    ...
                    <!-- Botón de ofertar -->
                    <div class="mt-auto">
                        <Button label="Ofertar" icon="pi pi-money-bill" class="w-full" 
                            severity="contrast" @click="openBidDialog(auction)"
